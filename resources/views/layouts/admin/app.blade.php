    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                <div class="sidebar-brand-text mx-3">PPKS IT Del</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('admin.profiles.index')}}">
                ...
                <a class="nav-link collapsed" href="{{route('admin.vidios.index')}}">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Vidio Edukasi</span>
                </a>

                <a class="nav-link collapsed" href="{{route('admin.document.index')}}">
                    <i class="fas fa-fw fa-file"></i>
...
<style>
    /* Memberikan jarak antara konten dan footer */
    .content-wrapper {
        min-height: calc(100vh - 150px);
        /* Pastikan footer tetap berada di bawah */
        padding-bottom: 50px;
        /* Atur jarak antara konten dan footer */
    }

    footer.sticky-footer {
        margin-top: 50px;
        /* Memberikan margin di atas footer */
    }
</style>